...
public class Fuzzy {
	...
	private double leftA = 10;
	private double leftB = 30;
	private double middleA = 10;
	private double middleB = 30;
	private double middleC = 50;
	private double middleD = 70;
	private double rightA = 50;
	private double ritghtB = 70;
	...
	public double checkRank(double angle){
		...
		double leftAlpha = Double.MAX_VALUE;
		double middleAlpha = Double.MAX_VALUE;
		double rightAlpha = Double.MAX_VALUE;
		...
		double turnAngle = (exAngle*leftAlpha+exAngle*middleAlpha+exAngle*rightAlpha)/(leftAlpha+middleAlpha+rightAlpha);
		return turnAngle;
	}
